export default function TraineeTermsAndConditions() {
  return (
    <div className="documentation__main">
      <div className="ud-container">
        <div id="terms" className="ud-text-with-links">
          ...
          <p>
            When you sign up to become an Trainee on the SABOORA platform,
            you agree to abide by these Trainee Terms ("
            <b>Terms</b>"). These Terms cover details about the aspects of the
            SABOORA platform relevant to Trainees and are incorporated by
          ...
          <p>
            As an Trainee, you are contracting directly with SABOORA, Inc. (a
          ...
          <p>
            The SABOORA platform allows you to add other users as co-Trainees
            ...
            of SABOORA's terms and policies by your co-Trainee or teaching
            ...
            any disputes between you and such users. If your co-Trainees have
          ...
          <p>
            ...
            Programs, and except for sales through Trainee-generated coupon
          ...
          <p>
            SABOORA makes all Trainee payments in U.S. dollars (USD)
